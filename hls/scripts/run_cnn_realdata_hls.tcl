open_project cnn_realdata_hls_prj
set_top cnn_realdata_hls
...
add_files src/cnn_realdata_hls.cpp -cflags "-Iinclude"

add_files -tb tb/test_cnn_realdata_hls.cpp -cflags "-Iinclude"
